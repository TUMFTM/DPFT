...
class BackboneBase(nn.Module):
    def __init__(self,
                 ...
                 **kwargs):
        """Base class for ConvNeXt backbones with intermediate returns.

        Arguments:
            backbone: Backbone model to use. ConvNeXt
                variant (e.g. ConvNeXt_Tiny)
...
def build_convnext(*args, **kwargs):
