...
class BackboneBase(nn.Module):
    def __init__(self,
                 ...
                 **kwargs):
        """Base class for RegNet backbones with intermediate returns.

        Arguments:
            backbone: Backbone model to use. Must be a variant of
                RegNet (e.g. RegNet_Y_1_6GF).
        ...
        return_layers = {'block' + str(i + 1): str(i + 1) for i in range(self._multi_scale)}
        self.body = IntermediateLayerGetter(backbone.trunk_output, return_layers=return_layers)
